...
// if (document.getElementById("open_invitation")){
...
// Define and directly call the functions
function init() {
    open_invitation();
    setupAudio();
    setupLightbox();
...
// Function to open invitation directly
function open_invitation() {
    confirm_open_invitation();
}

// Function to handle the opening of the invitation
function confirm_open_invitation() {
    var container = document.querySelector(".container");
    var cover = document.querySelector("#cover");
    var index = document.querySelector("#index");
...
function setupAudio() {
    ...
    // Directly set the play/pause button functionality
    document.querySelector("#play_button").addEventListener("click", function() {
        play_pause(this);
    });
}

// Setup lightbox directly
...
// Setup Intersection Observer directly
...
// Call the init function to execute everything
init();
